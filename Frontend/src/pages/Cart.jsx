        ...
        <div>
          {
            cartData.map((item, index) => {
              ...
              return(
                <div key={index} className="max-w-6xl mx-auto py-6 border-b text-gray-700 grid grid-cols-[3fr_2fr_auto] sm:grid-cols-[4fr_2fr_auto] items-center gap-6 group transition-all duration-300">
