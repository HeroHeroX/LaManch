...
const ChatbotAI = () => {
  ...
  const [messages, setMessages] = useState([
    { text: "La Manchへようこそ！私はAIアシスタントです。モデル、サイズ、返品・交換ポリシーについてご案内できます。何をお探しですか？", sender: 'ai' }
  ]);
  ...
  return (
    ...
    <div className="fixed bottom-20 right-3 z-50"> 
      ...
      <button 
        className="fixed bottom-18 right-3 p-3 bg-black text-white rounded-full shadow-lg hover:bg-gray-500 transition-all duration-300 z-50 cursor-pointer"
