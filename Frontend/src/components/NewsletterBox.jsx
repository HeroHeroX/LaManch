...
const NewsletterBox = () => {
  ...
  return (
    <div className='text-center bg-[#F8F9FA] pb-10'>
      <p className='text-[25px] font-bold text-gray-800'>Subscribe now & get 20% off</p>
      <p className='text-gray-500 mt-3 text-[20px]'>Sign up today to unlock timeless styles, curated collections, and members‑only deals..</p>
