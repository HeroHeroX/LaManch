...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between px-4 py-5 font-medium bg-[#DFDFDC]'>
              ...
              {token && isOpen && (
                <div className="absolute right-0 pt-4">
                  <div className="flex flex-col gap-2 w-36 py-3 px-4 bg-slate-100 text-gray-500 rounded">
                    <p className="cursor-pointer hover:text-black">マイベージ</p>
                    <p
        ...
        {/* Mobile Menu */}
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-[#DFDFDC] transition-all ${visible ? 'w-full' : 'w-0'}`}>
            <div className='flex flex-col text-gray-600'>
              <div onClick={()=>setVisible(false)} className='flex items-center gap-4 p-3 cursor-pointer h'>
